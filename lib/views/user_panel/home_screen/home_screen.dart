                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Column(
                                children: [
                                  // Using GetBuilder with your controllers
                                  GetBuilder<CapitalController>(builder: (capitalController) {
                                    return ModernMetricCard(
                                      title: 'Capital',
                                      amount: '৳ ${capitalController.totalCapitalAmount.toStringAsFixed(2)}',
                                      color: const Color(0xFF3B82F6),
                                      icon: Icons.account_balance_wallet_rounded,
                                      onTap: () => Get.to(() => CapitalScreen()),
                                    );
                                  }),
                                  ...
                                  GetBuilder<ProfitController>(builder: (profitController) {
                                    return ModernMetricCard(
                                      title: 'Profit',
                                      amount: '৳ ${profitController.totalProfitAmount.toStringAsFixed(2)}',
                                  ...
                                  GetBuilder<InvestmentController>(builder: (investmentController) {
                                    return ModernMetricCard(
                                      title: 'Investment',
                                      amount: '৳ ${investmentController.totalInvestAmount.toStringAsFixed(2)}',
                                      color: const Color(0xFF8B5CF6),
                                      icon: Icons.savings_rounded,
                                      onTap: () => Get.to(() => const InvestScreen()),
                                    );
                                  }),
                                  ...
                                  GetBuilder<ExpenseController>(builder: (expenseController) {
                                    return ModernMetricCard(
                                      title: 'Expense',
                                      amount: '৳ ${expenseController.totalExpenseAmount.toStringAsFixed(2)}',
                                      color: const Color(0xFFEF4444),
                                      icon: Icons.receipt_long_rounded,
                                      onTap: () => Get.to(() => ExpenseScreen()),
                                    );
                                  }),
                                ],
                              ),
                      ...
                      builder: (capitalController) {
                        return GetBuilder<ProfitController>(
                          builder: (profitController) {
                            final totalInvest = Get.find<InvestmentController>().totalInvestAmount;
                            final totalExpense = Get.find<ExpenseController>().totalExpenseAmount;
                            final currentBalance = (capitalController.totalCapitalAmount +
                                profitController.totalProfitAmount - (totalInvest + totalExpense)).toStringAsFixed(2);
                  ...
                  Expanded(
                    child: GetBuilder<CapitalController>(
                      builder: (capitalController) {
                        return GetBuilder<ExpenseController>(
                          builder: (expenseController) {
                            final netBalance = (capitalController.totalCapitalAmount +
                                Get.find<ProfitController>().totalProfitAmount -
                                expenseController.totalExpenseAmount).toStringAsFixed(2);
